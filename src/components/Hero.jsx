    ...
    <section className="min-h-screen bg-[#fefdf9] relative overflow-hidden">
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="grid lg:grid-cols-[1.5fr,400px] gap-8 lg:gap-12 items-start">
          {/* Left Content */}
          <div className="flex flex-col justify-start pt-8 w-full">
            ...
            {/* PRIORITIZED LCP ELEMENT (Removed Framer Motion Here) */}
            <p className="mt-6 text-lg text-gray-600 leading-relaxed max-w-3xl">
              ...
              students face when tackling engineering assignments. Our platform
              offers reliable and comprehensive engineering assignment help to
              students who need help with their assignments. Our team of
              engineering assignment writers provides top-notch engineering
              assignment writing services to help you excel in your studies and
          ...
          <motion.div
            ...
            transition={{ duration: 0.3 }} // Reduced animation delay
        ...
        <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
          {[
            { icon: Phone, title: "800+", text: "Professional writers" },
            { icon: MessageSquare, title: "Direct 24/7", text: "chat" },
            { icon: ShieldCheck, title: "Plagiarism-", text: "free content" },
            { icon: BrainCircuit, title: "Non-AI", text: "Content" },
          ].map((feature, index) => (
            <motion.div
              key={feature.title}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.3, delay: index * 0.05 }} // Faster loading
