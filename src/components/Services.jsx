    ...
    <>
      <div id="subject" className=" slider-container w-full relative">
        ...
        <p className="max-[480px]:px-2 text-center max-w-screen-2xl mx-auto text-[1.3rem]">
          EngineeringAssignmentHelp.com understands that engineering students
          face a variety of academic challenges. To support your success, we
          offer a comprehensive range of engineering assignment help services
          tailored to meet your specific needs. Whether you're struggling with
          an essay, a complex thesis, or preparing for an exam, our team of
          expert engineering assignment writers is here to provide you with the
